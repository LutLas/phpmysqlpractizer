...
class Disclaimer {
    ...
    public function index() {
     ...
     "Some of the material might be potentially unsuitable for children, consisting of strong language or depictions of violence, sex, or substance abuse hence parental guidance or adult supervision is highly requested.",
